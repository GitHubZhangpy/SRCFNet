function im_data = getdata(image,im_params)

im_data.currentScaleFactor = im_params.currentScaleFactor;
im_data.base_target_sz = im_params.base_target_sz;
im_data.use_sz = im_params.use_sz;
im_data.sz = im_params.sz;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% im_data.l = zeros([im_data.use_sz,im_data.feature_dim]);
% im_data.l_dft=fft2(im_data.l);
% im_data.l_reshaped=reshape(im_data.l_dft,[im_data.support_sz,im_data.feature_dim]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     im_params.reg_window_min = im_params.reg_window_power;
...
im_data.multires_pixel_template = zeros(single(im_data.sz(1)), single(im_data.sz(2)), size(image,3), im_params.nScales, 'uint8');
