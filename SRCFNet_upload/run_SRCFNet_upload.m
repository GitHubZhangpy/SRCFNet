...
function results=run_SRDCF_net(seq, res_path, bSaveImage, parameters)
...
params.reg_window_min = 0.1;	% default 0		% the minimum value of the regularization window % default 0.1
params.reg_window_edge = 3;  % 3         % the impact of the spatial regularization (value at the target border), depends on the detection size and the feature dimensionality
